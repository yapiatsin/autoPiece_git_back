...
CUSTOM_PERMISSIONS = [{'categorie': 'Comptes', 'name': 'Active Compte', 'url': 'active_compte'},
 ...
 {'categorie': 'Stocks', 'name': 'Export Caisse Ventes Excel', 'url': 'export_caisse_ventes_excel'},
 {'categorie': 'Stocks', 'name': 'Export Caisse Ventes Pdf', 'url': 'export_caisse_ventes_pdf'},
 {'categorie': 'Stocks', 'name': 'Export Cmd Line Excel', 'url': 'export_cmd_line_excel'},
 {'categorie': 'Stocks', 'name': 'Export Cmd Line Pdf', 'url': 'export_cmd_line_pdf'},
 {'categorie': 'Stocks', 'name': 'Export Entrees Piece Excel', 'url': 'export_entrees_piece_excel'},
 {'categorie': 'Stocks', 'name': 'Export Entrees Piece Pdf', 'url': 'export_entrees_piece_pdf'},
 {'categorie': 'Stocks', 'name': 'Export Hist Cmd Excel', 'url': 'export_hist_cmd_excel'},
