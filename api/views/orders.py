...
def build_order_detail(request, commande):
    ...
    return {
        ...
        'livraison_ville': panier.livraison_ville.nom if panier.livraison_ville_id else '',
        'livraison_commune': panier.livraison_commune.nom if panier.livraison_commune_id else '',
    ...
    def get(self, request):
        ...
        for cmd in qs[:100]:
            results.append({
                ...
                'livraison_ville': cmd.panier.livraison_ville.nom if cmd.panier.livraison_ville_id else '',
                'livraison_commune': cmd.panier.livraison_commune.nom if cmd.panier.livraison_commune_id else '',
