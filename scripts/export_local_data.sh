...
echo "    docker compose cp data_export.json autopiece-web:/tmp/data_export.json"
echo "    docker compose exec -T autopiece-web python manage.py loaddata /tmp/data_export.json"
