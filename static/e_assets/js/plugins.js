...
! function(e, t) {
    ...
    function a(e, i) {
        void 0 === e && (e = {}), void 0 === i && (i = {}), Object.keys(i).forEach(function(s) {
    ...
    var u = function(e) {
        ...
        function i(t) {
            ...
            return s = (i = function(e) {
                ...
                return e
            }(a = e.call.apply(e, [this].concat(t)) || this)).__proto__, Object.defineProperty(i, "__proto__", {
                get: function() {
                    return s
                },
                set: function(e) {
    ...
    var f, m, g, $ = {
            ...
            function l(e) {
                ...
                if (t) {
                    ...
                    if (0 > a.indexOf(e) && a.unshift(e), v(t).is(s)) r.apply(t, a);
                        ...
                        for (var i = v(t).parents(), n = 0; n < i.length; n += 1) v(i[n]).is(s) && r.apply(i[n], a)
                }
            }
        ...
        parents: function(e) {
            for (var t = [], a = 0; a < this.length; a += 1)
                for (var i = this[a].parentNode; i;) e ? v(i).is(e) && t.push(i) : t.push(i), i = i.parentNode;
            return v(t)
        },
        closest: function(e) {
            var t = this;
        ...
        children: function(e) {
            for (var t = [], a = 0; a < this.length; a += 1)
                for (var i = this[a].children, s = 0; s < i.length; s += 1) e && !v(i[s]).is(e) || t.push(i[s]);
            return v(t)
        },
        filter: function(e) {
            return v(h(this, e))
    ...
    function C(e, t) {
        Object.keys(t).forEach(function(a) {
            _(t[a]) && Object.keys(t[a]).forEach(function(i) {
            ...
            if (("wrapper" !== l.touchEventsTarget || p.closest(t.wrapperEl).length) && (r.isTouchEvent = "touchstart" === d.type, (r.isTouchEvent || !("which" in d) || 3 !== d.which) && !(!r.isTouchEvent && "button" in d && d.button > 0 || r.isTouched && r.isMoved))) {
                ...
                if (l.noSwiping && (c ? function(e, t) {
                    ...
                    if (x(r, {
                            ...
                            isScrolling: void 0,
                            startMoving: void 0
                        }), o.startX = h, o.startY = f, r.touchStartTime = w(), t.allowClick = !0, t.updateSize(), t.swipeDirection = void 0, l.threshold > 0 && (r.allowThresholdMove = !1), "touchstart" !== d.type) {
                        var $ = !0;
        ...
        if (a.enabled) {
            ...
            if (o.originalEvent && (o = o.originalEvent), i.isTouched) {
                if (!i.isTouchEvent || "touchmove" === o.type) {
                    ...
                    if (!a.allowTouchMove) return a.allowClick = !1, void(i.isTouched && (x(n, {
                        startX: p,
                        startY: u,
                        currentX: p,
                        currentY: u
                    ...
                    if (i.allowTouchCallbacks && a.emit("touchMove", o), !(o.targetTouches && o.targetTouches.length > 1)) {
                        ...
                        if (!(a.params.threshold && Math.sqrt(Math.pow(h, 2) + Math.pow(f, 2)) < a.params.threshold)) {
                            if (void 0 === i.isScrolling && (a.isHorizontal() && n.currentY === n.startY || a.isVertical() && n.currentX === n.startX ? i.isScrolling = !1 : h * h + f * f >= 25 && (c = 180 * Math.atan2(Math.abs(f), Math.abs(h)) / Math.PI, i.isScrolling = a.isHorizontal() ? c > r.touchAngle : 90 - c > r.touchAngle)), i.isScrolling && a.emit("touchMoveOpposite", o), void 0 === i.startMoving && (n.currentX === n.startX && n.currentY === n.startY || (i.startMoving = !0)), i.isScrolling) i.isTouched = !1;
    ...
    function L(e) {
        ...
        if (t.enabled) {
            ...
            if (t.allowClick && (t.updateClickedSlide(d), t.emit("tap click", d), c < 300 && u - a.lastClickTime < 300 && t.emit("doubleTap doubleClick", d)), a.lastClickTime = w(), b(function() {
            ...
            if (a.isTouched = !1, a.isMoved = !1, a.startMoving = !1, p = i.followFinger ? r ? t.translate : -t.translate : -a.currentTranslate, !i.cssMode) {
                if (i.freeMode) {
                    ...
                    if (i.freeModeMomentum) {
                        ...
                        if (y < t.maxTranslate()) i.freeModeMomentumBounce ? (y + t.maxTranslate() < -C && (y = t.maxTranslate() - C), _ = t.maxTranslate(), x = !0, a.allowMomentumBounce = !0) : y = t.maxTranslate(), i.loop && i.centeredSlides && (E = !0);
                        else if (y > t.minTranslate()) i.freeModeMomentumBounce ? (y - t.minTranslate() > C && (y = t.minTranslate() + C), _ = t.minTranslate(), x = !0, a.allowMomentumBounce = !0) : y = t.minTranslate(), i.loop && i.centeredSlides && (E = !0);
                        ...
                        i.freeModeMomentumBounce && x ? (t.updateProgress(_), t.setTransition(g), t.setTranslate(y), t.transitionStart(!0, t.swipeDirection), t.animating = !0, n.transitionEnd(function() {
                    ...
                    if (c > i.longSwipesMs) {
                        ...
                        t.navigation && (d.target === t.navigation.nextEl || d.target === t.navigation.prevEl) ? d.target === t.navigation.nextEl ? t.slideTo(k + D) : t.slideTo(k) : ("next" === t.swipeDirection && t.slideTo(k + D), "prev" === t.swipeDirection && t.slideTo(k))
                    }
                }
            }
        }
    ...
    var G = {
        ...
        B = {
            ...
            update: {
                ...
                updateSlides: function() {
                    ...
                    var g = e.snapGrid.length,
                        ...
                        _ = 0;
                    if (void 0 !== r) {
                        "string" == typeof b && b.indexOf("%") >= 0 && (b = parseFloat(b.replace("%", "")) / 100 * r), e.virtualSize = -b, n ? p.css({
                            marginLeft: "",
                            marginBottom: "",
                            marginTop: ""
                        }) : p.css({
                            ...
                            marginBottom: "",
                            marginTop: ""
                        }), i.slidesPerColumn > 1 && (E = Math.floor(u / i.slidesPerColumn) === u / e.params.slidesPerColumn ? u : Math.ceil(u / i.slidesPerColumn) * i.slidesPerColumn, "auto" !== i.slidesPerView && "row" === i.slidesPerColumnFill && (E = Math.max(E, i.slidesPerView * i.slidesPerColumn)));
                        for (var E, C, T, S, z, P = i.slidesPerColumn, k = E / P, M = Math.floor(u / i.slidesPerColumn), L = 0; L < u; L += 1) {
                            ...
                            if (i.slidesPerColumn > 1) {
                                ...
                                if ("row" === i.slidesPerColumnFill && i.slidesPerGroup > 1) {
                                    ...
                                    O = (D = G - (A = Math.floor(G / B)) * B + N * i.slidesPerGroup) + A * E / P, I.css({
                            ...
                            if ("none" !== I.css("display")) {
                                ...
                                p[L] && (p[L].swiperSlideSize = C), v.push(C), i.centeredSlides ? (w = w + C / 2 + y / 2 + b, 0 === y && 0 !== L && (w = w - r / 2 - b), 0 === L && (w = w - r / 2 - b), .001 > Math.abs(w) && (w = 0), i.roundLengths && (w = Math.floor(w)), _ % i.slidesPerGroup == 0 && c.push(w), h.push(w)) : (i.roundLengths && (w = Math.floor(w)), (_ - Math.min(e.params.slidesPerGroupSkip, _)) % e.params.slidesPerGroup == 0 && c.push(w), h.push(w), w = w + C + b), e.virtualSize += C + b, y = C, _ += 1
                            }
                        }
                        if (e.virtualSize = Math.max(e.virtualSize, r) + m, n && l && ("slide" === i.effect || "coverflow" === i.effect) && s.css({
                                width: e.virtualSize + i.spaceBetween + "px"
                            }), i.setWrapperSize && s.css(((S = {})[t("width")] = e.virtualSize + i.spaceBetween + "px", S)), i.slidesPerColumn > 1 && (e.virtualSize = (C + i.spaceBetween) * E, e.virtualSize = Math.ceil(e.virtualSize / i.slidesPerColumn) - i.spaceBetween, s.css(((z = {})[t("width")] = e.virtualSize + i.spaceBetween + "px", z)), i.centeredSlides)) {
                            T = [];
                        ...
                        if (0 === c.length && (c = [0]), 0 !== i.spaceBetween) {
                            var et, ea = e.isHorizontal() && n ? "marginLeft" : t("marginRight");
                        ...
                        x(e, {
                            ...
                            slidesGrid: h,
                            slidesSizesGrid: v
                        }), u !== d && e.emit("slidesLengthChange"), c.length !== g && (e.params.watchOverflow && e.checkOverflow(), e.emit("snapGridLengthChange")), h.length !== $ && e.emit("slidesGridLengthChange"), (i.watchSlidesProgress || i.watchSlidesVisibility) && e.updateSlidesOffset()
                    }
                },
                ...
                updateProgress: function(e) {
                    ...
                    var a = this.params,
                        ...
                        l = r,
                        o = n;
                    0 === i ? (s = 0, r = !0, n = !0) : (r = (s = (e - this.minTranslate()) / i) <= 0, n = s >= 1), x(this, {
                        progress: s,
                        isBeginning: r,
                        isEnd: n
                    }), (a.watchSlidesProgress || a.watchSlidesVisibility || a.centeredSlides && a.autoHeight) && this.updateSlidesProgress(e), r && !l && this.emit("reachBeginning toEdge"), n && !o && this.emit("reachEnd toEdge"), (l && !r || o && !n) && this.emit("fromEdge"), this.emit("progress", s)
                },
                ...
                updateClickedSlide: function(e) {
                    ...
                    a.clickedSlide = s, a.virtual && a.params.virtual.enabled ? a.clickedIndex = parseInt(v(s).attr("data-swiper-slide-index"), 10) : a.clickedIndex = t, i.slideToClickedSlide && void 0 !== a.clickedIndex && a.clickedIndex !== a.activeIndex && a.slideToClickedSlide()
                }
            },
            translate: {
            ...
            slide: {
                slideTo: function(e, t, a, i, s) {
                    if (void 0 === e && (e = 0), void 0 === t && (t = this.params.speed), void 0 === a && (a = !0), "number" != typeof e && "string" != typeof e) throw Error("The 'index' argument cannot have type other than 'number' or 'string'. [" + typeof e + "] given.");
                    if ("string" == typeof e) {
                        var r = parseInt(e, 10);
                    ...
                    if ($ = l > c ? "next" : l < c ? "prev" : "reset", h && -b === n.translate || !h && b === n.translate) return n.updateActiveIndex(l), o.autoHeight && n.updateAutoHeight(), n.updateSlidesClasses(), "slide" !== o.effect && n.setTranslate(b), "reset" !== $ && (n.transitionStart(a, $), n.transitionEnd(a, $)), !1;
                    if (o.cssMode) {
                        var x, C = n.isHorizontal(),
                            T = -b;
                        return (h && (T = v.scrollWidth - v.offsetWidth - T), 0 === t) ? v[C ? "scrollLeft" : "scrollTop"] = T : v.scrollTo ? v.scrollTo(((x = {})[C ? "left" : "top"] = T, x.behavior = "smooth", x)) : v[C ? "scrollLeft" : "scrollTop"] = T, !0
                    }
                    return 0 === t ? (n.setTransition(0), n.setTranslate(b), n.updateActiveIndex(l), n.updateSlidesClasses(), n.emit("beforeTransitionStart", t, i), n.transitionStart(a, $), n.transitionEnd(a, $)) : (n.setTransition(t), n.setTranslate(b), n.updateActiveIndex(l), n.updateSlidesClasses(), n.emit("beforeTransitionStart", t, i), n.transitionStart(a, $), n.animating || (n.animating = !0, n.onSlideToWrapperTransitionEnd || (n.onSlideToWrapperTransitionEnd = function(e) {
                        n && !n.destroyed && e.target === this && (n.$wrapperEl[0].removeEventListener("transitionend", n.onSlideToWrapperTransitionEnd), n.$wrapperEl[0].removeEventListener("webkitTransitionEnd", n.onSlideToWrapperTransitionEnd), n.onSlideToWrapperTransitionEnd = null, delete n.onSlideToWrapperTransitionEnd, n.transitionEnd(a, $))
                ...
                slidePrev: function(e, t, a) {
                    ...
                    return void 0 === c && s.cssMode && n.forEach(function(e) {
                        !c && u >= e && (c = e)
                    }), void 0 !== c && (p = l.indexOf(c)) < 0 && (p = i.activeIndex - 1), i.slideTo(p, e, t, a)
                },
                ...
                slideToClickedSlide: function() {
                    ...
                    if (a.loop) {
                        ...
                        e = parseInt(v(t.clickedSlide).attr("data-swiper-slide-index"), 10), a.centeredSlides ? r < t.loopedSlides - s / 2 || r > t.slides.length - t.loopedSlides + s / 2 ? (t.loopFix(), r = i.children("." + a.slideClass + '[data-swiper-slide-index="' + e + '"]:not(.' + a.slideDuplicateClass + ")").eq(0).index(), b(function() {
                            t.slideTo(r)
                ...
                attachEvents: function() {
                    ...
                    if (!o.touch && o.pointerEvents) r.addEventListener(i.start, e.onTouchStart, !1), t.addEventListener(i.move, e.onTouchMove, d), t.addEventListener(i.end, e.onTouchEnd, !1);
                        ...
                        if (o.touch) {
                            ...
                            r.addEventListener(i.start, e.onTouchStart, p), r.addEventListener(i.move, e.onTouchMove, o.passiveListener ? {
                                passive: !1,
                                capture: d
                            } : d), r.addEventListener(i.end, e.onTouchEnd, p), i.cancel && r.addEventListener(i.cancel, e.onTouchEnd, p), A || (t.addEventListener("touchstart", N), A = !0)
                    ...
                    }(a.preventClicks || a.preventClicksPropagation) && r.addEventListener("click", e.onClick, !0), a.cssMode && n.addEventListener("scroll", e.onScroll), a.updateOnWindowResize ? e.on(l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I, !0) : e.on("observerUpdate", I, !0)
                },
                detachEvents: function() {
                    ...
                    if (!l.touch && l.pointerEvents) i.removeEventListener(a.start, this.onTouchStart, !1), e.removeEventListener(a.move, this.onTouchMove, o), e.removeEventListener(a.end, this.onTouchEnd, !1);
                        ...
                        if (l.touch) {
                            ...
                            i.removeEventListener(a.start, this.onTouchStart, d), i.removeEventListener(a.move, this.onTouchMove, o), i.removeEventListener(a.end, this.onTouchEnd, d), a.cancel && i.removeEventListener(a.cancel, this.onTouchEnd, d)
                        }(t.simulateTouch && !n.ios && !n.android || t.simulateTouch && !l.touch && n.ios) && (i.removeEventListener("mousedown", this.onTouchStart, !1), e.removeEventListener("mousemove", this.onTouchMove, o), e.removeEventListener("mouseup", this.onTouchEnd, !1))
                    }(t.preventClicks || t.preventClicksPropagation) && i.removeEventListener("click", this.onClick, !0), t.cssMode && r.removeEventListener("scroll", this.onScroll), this.off(n.ios || n.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", I)
                }
            },
            breakpoints: {
                    ...
                    if (n && (!n || 0 !== Object.keys(n).length)) {
                        ...
                        if (l && e.currentBreakpoint !== l) {
                            ...
                            var d = o || e.originalParams,
                                ...
                                c = s.enabled;
                            p && !u ? (r.removeClass(s.containerModifierClass + "multirow " + s.containerModifierClass + "multirow-column"), e.emitContainerClasses()) : !p && u && (r.addClass(s.containerModifierClass + "multirow"), (d.slidesPerColumnFill && "column" === d.slidesPerColumnFill || !d.slidesPerColumnFill && "column" === s.slidesPerColumnFill) && r.addClass(s.containerModifierClass + "multirow-column"), e.emitContainerClasses());
                            ...
                            }), c && !f ? e.disable() : !c && f && e.enable(), e.currentBreakpoint = l, e.emit("_beforeBreakpoint", d), v && a && (e.loopDestroy(), e.loopCreate(), e.updateSlides(), e.slideTo(t - (void 0 === i ? 0 : i) + e.loopedSlides, 0, !1)), e.emit("breakpoint", d)
                        }
                    }
                },
                ...
                addClasses: function() {
                    var e, t, a, i = this.classNames,
                        ...
                        d = (e = ["initialized", s.direction, {
                            ...
                            "css-mode": s.cssMode
                        }], t = s.containerModifierClass, a = [], e.forEach(function(e) {
        ...
        X = function() {
            function e() {
                ...
                if (1 === s.length && s[0].constructor && "Object" === Object.prototype.toString.call(s[0]).slice(8, -1) ? a = s[0] : (t = s[0], a = s[1]), a || (a = {}), a = x({}, a), t && !a.el && (a.el = t), a.el && v(a.el).length > 1) {
                    var l = [];
                    return v(a.el).each(function(t) {
                        var i = x({}, a, {
                            el: t
                        });
                        l.push(new e(i))
                ...
                var o, d, p, u, c, h, f, $, b, y, _, E, C, T, S, P, k, M = this;
                M.__swiper__ = !0, M.support = z(), M.device = (o = {
                    userAgent: a.userAgent
                }, m || (m = (p = (void 0 === (d = o) ? {} : d).userAgent, u = z(), h = (c = n()).navigator.platform, f = p || c.navigator.userAgent, $ = {
                    ios: !1,
                    android: !1
                }, b = c.screen.width, y = c.screen.height, _ = f.match(/(Android);?[\s\/]+([\d.]+)?/), E = f.match(/(iPad).*OS\s([\d_]+)/), C = f.match(/(iPod)(.*OS\s([\d_]+))?/), T = !E && f.match(/(iPhone\sOS|iOS)\s([\d_]+)/), S = "MacIntel" === h, !E && S && u.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(b + "x" + y) >= 0 && ((E = f.match(/(Version)\/([\d.]+)/)) || (E = [0, 1, "13_0_0"]), S = !1), _ && "Win32" !== h && ($.os = "android", $.android = !0), (E || T || C) && ($.os = "ios", $.ios = !0), $)), m), M.browser = (g || (g = {
                    ...
                    if (t.params) {
                        var i = Object.keys(t.params)[0],
                            s = t.params[i];
                        if ("object" != typeof s || null === s || (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === a[i] && (a[i] = {
                                auto: !0
                ...
                var L, I, O = x({}, G);
                return M.useParams(O), M.params = x({}, O, H, a), M.originalParams = x({}, M.params), M.passedParams = x({}, a), M.params && M.params.on && Object.keys(M.params.on).forEach(function(e) {
                    M.on(e, M.params.on[e])
                }), M.params && M.params.onAny && M.onAny(M.params.onAny), M.$ = v, x(M, {
            ...
            return r.enable = function() {
                ...
                if (e.centeredSlides) {
                    ...
                    for (var p = s + 1; p < t.length; p += 1) a[p] - a[s] < i && (r += 1);
                return r
            }, r.update = function() {
                var e = this;
                if (e && !e.destroyed) {
                ...
                if (0 === r.length && t.params.createElements) {
                    ...
                    r = v(n), n.className = t.params.wrapperClass, a.append(n), a.children("." + t.params.slideClass).each(function(e) {
                        r.append(e)
                    })
                }
                return x(t, {
                ...
                return void 0 === i.params || i.destroyed || (i.emit("beforeDestroy"), i.initialized = !1, i.detachEvents(), s.loop && i.loopDestroy(), t && (i.removeClasses(), r.removeAttr("style"), n.removeAttr("style"), l && l.length && l.removeClass([s.slideVisibleClass, s.slideActiveClass, s.slideNextClass, s.slidePrevClass].join(" ")).removeAttr("style").removeAttr("data-swiper-slide-index")), i.emit("destroy"), Object.keys(i.eventsListeners).forEach(function(e) {
                    i.off(e)
                }), !1 !== e && (i.$el[0].swiper = null, Object.keys(a = i).forEach(function(e) {
                    try {
                        a[e] = null
                    } catch (t) {}
                    try {
    ...
    var Y = {
            update: function(e) {
                ...
                if (x(t.virtual, {
                    ...
                    }), p === w && u === y && !e) return t.slidesGrid !== h && _ !== f && t.slides.css(m, _ + "px"), void t.updateProgress();
                ...
                if (e) t.$wrapperEl.find("." + t.params.slideClass).remove();
                    ...
                    for (var S = p; S <= u; S += 1)(S < w || S > y) && t.$wrapperEl.find("." + t.params.slideClass + '[data-swiper-slide-index="' + S + '"]').remove();
                ...
                }), t.$wrapperEl.children(".swiper-slide").css(m, _ + "px"), E()
            },
            ...
            handle: function(e) {
                if (this.enabled) {
                    ...
                    if (!(r.shiftKey || r.altKey || r.ctrlKey || r.metaKey || a.activeElement && a.activeElement.nodeName && ("input" === a.activeElement.nodeName.toLowerCase() || "textarea" === a.activeElement.nodeName.toLowerCase()))) {
                        ...
                        this.isHorizontal() ? ((d || p || u || c) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), ((p || c) && !i || (d || u) && i) && this.slideNext(), ((d || u) && !i || (p || c) && i) && this.slidePrev()) : ((d || p || h || v) && (r.preventDefault ? r.preventDefault() : r.returnValue = !1), (p || v) && this.slideNext(), (d || h) && this.slidePrev()), this.emit("keyPress", l)
                    }
                }
            },
            enable: function() {
        ...
        V = {
                    ...
                    if (o >= a.minTranslate() && (o = a.minTranslate()), o <= a.maxTranslate() && (o = a.maxTranslate()), (a.params.loop || !(o === a.minTranslate() || o === a.maxTranslate())) && a.params.nested && t.stopPropagation(), a.params.freeMode) {
                        ...
                        if (!u) {
                            ...
                            var c = a.getTranslate() + r * i.sensitivity,
                                h = a.isBeginning,
                                f = a.isEnd;
                            if (c >= a.minTranslate() && (c = a.minTranslate()), c <= a.maxTranslate() && (c = a.maxTranslate()), a.setTransition(0), a.setTranslate(c), a.updateProgress(), a.updateActiveIndex(), a.updateSlidesClasses(), (!h && a.isBeginning || !f && a.isEnd) && a.updateSlidesClasses(), a.params.freeModeSticky) {
            ...
            enable: function() {
                ...
                var a = e.$el;
                return "container" !== e.params.mousewheel.eventsTarget && (a = v(e.params.mousewheel.eventsTarget)), a.on("mouseenter", e.mousewheel.handleMouseEnter), a.on("mouseleave", e.mousewheel.handleMouseLeave), a.on(t, e.mousewheel.handle), e.mousewheel.enabled = !0, !0
            },
            disable: function() {
                var e = this,
                    t = V.event();
        ...
        W = {
            ...
            update: function() {
                ...
                if (!this.params.loop) {
                    var a = this.navigation,
                        i = a.$nextEl,
                        s = a.$prevEl;
                    s && s.length > 0 && (t(s, !!this.isBeginning), this.params.watchOverflow && this.enabled && s[this.isLocked ? "addClass" : "removeClass"](e.lockClass)), i && i.length > 0 && (t(i, !!this.isEnd), this.params.watchOverflow && this.enabled && i[this.isLocked ? "addClass" : "removeClass"](e.lockClass))
                }
            },
            ...
            init: function() {
                ...
                a.params.navigation = S(a.$el, a.params.navigation, a.params.createElements, {
                    nextEl: "swiper-button-next",
                    prevEl: "swiper-button-prev"
                }), (i.nextEl || i.prevEl) && (i.nextEl && (e = v(i.nextEl), a.params.uniqueNavElements && "string" == typeof i.nextEl && e.length > 1 && 1 === a.$el.find(i.nextEl).length && (e = a.$el.find(i.nextEl))), i.prevEl && (t = v(i.prevEl), a.params.uniqueNavElements && "string" == typeof i.prevEl && t.length > 1 && 1 === a.$el.find(i.prevEl).length && (t = a.$el.find(i.prevEl))), e && e.length > 0 && e.on("click", a.navigation.onNextClick), t && t.length > 0 && t.on("click", a.navigation.onPrevClick), x(a.navigation, {
                    $nextEl: e,
                    nextEl: e && e[0],
                    $prevEl: t,
                    prevEl: t && t[0]
            ...
            update: function() {
                ...
                if (a.el && e.pagination.el && e.pagination.$el && 0 !== e.pagination.$el.length) {
                    ...
                    if (e.params.loop ? ((i = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup)) > s - 1 - 2 * e.loopedSlides && (i -= s - 2 * e.loopedSlides), i > n - 1 && (i -= n), i < 0 && "bullets" !== e.params.paginationType && (i = n + i)) : i = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === a.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                        ...
                        if (a.dynamicBullets && (e.pagination.bulletSize = p.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), r.css(e.isHorizontal() ? "width" : "height", e.pagination.bulletSize * (a.dynamicMainBullets + 4) + "px"), a.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (e.pagination.dynamicBulletIndex += i - e.previousIndex, e.pagination.dynamicBulletIndex > a.dynamicMainBullets - 1 ? e.pagination.dynamicBulletIndex = a.dynamicMainBullets - 1 : e.pagination.dynamicBulletIndex < 0 && (e.pagination.dynamicBulletIndex = 0)), d = ((o = (l = i - e.pagination.dynamicBulletIndex) + (Math.min(p.length, a.dynamicMainBullets) - 1)) + l) / 2), p.removeClass(a.bulletActiveClass + " " + a.bulletActiveClass + "-next " + a.bulletActiveClass + "-next-next " + a.bulletActiveClass + "-prev " + a.bulletActiveClass + "-prev-prev " + a.bulletActiveClass + "-main"), r.length > 1) p.each(function(e) {
                            var t = v(e),
                                s = t.index();
                    ...
                    if ("fraction" === a.type && (r.find(T(a.currentClass)).text(a.formatFractionCurrent(i + 1)), r.find(T(a.totalClass)).text(a.formatFractionTotal(n))), "progressbar" === a.type) {
                        ...
                        var w, y = (i + 1) / n,
                            _ = 1,
                            E = 1;
                        "horizontal" === w ? _ = y : E = y, r.find(T(a.progressbarFillClass)).transform("translate3d(0,0,0) scaleX(" + _ + ") scaleY(" + E + ")").transition(e.params.speed)
                    }
        ...
        F = {
            ...
            updateSize: function() {
                if (this.params.scrollbar.el && this.scrollbar.el) {
                    ...
                    var i, s = this.isHorizontal() ? a[0].offsetWidth : a[0].offsetHeight,
                        r = this.size / this.virtualSize,
                        n = r * (s / this.size);
                    i = "auto" === this.params.scrollbar.dragSize ? s * r : parseInt(this.params.scrollbar.dragSize, 10), this.isHorizontal() ? t[0].style.width = i + "px" : t[0].style.height = i + "px", a[0].style.display = r >= 1 ? "none" : "", this.params.scrollbar.hide && (a[0].style.opacity = 0), x(e, {
                        trackSize: s,
                        divider: r,
                        moveDivider: n,
                        dragSize: i
            ...
            enableDraggable: function() {
                if (this.params.scrollbar.el) {
                    ...
                    l && (n.touch ? (l.addEventListener(a.start, this.scrollbar.onDragStart, o), l.addEventListener(a.move, this.scrollbar.onDragMove, o), l.addEventListener(a.end, this.scrollbar.onDragEnd, d)) : (l.addEventListener(i.start, this.scrollbar.onDragStart, o), e.addEventListener(i.move, this.scrollbar.onDragMove, o), e.addEventListener(i.end, this.scrollbar.onDragEnd, d)))
                }
            },
            disableDraggable: function() {
                if (this.params.scrollbar.el) {
                    ...
                    l && (n.touch ? (l.removeEventListener(a.start, this.scrollbar.onDragStart, o), l.removeEventListener(a.move, this.scrollbar.onDragMove, o), l.removeEventListener(a.end, this.scrollbar.onDragEnd, d)) : (l.removeEventListener(i.start, this.scrollbar.onDragStart, o), e.removeEventListener(i.move, this.scrollbar.onDragMove, o), e.removeEventListener(i.end, this.scrollbar.onDragEnd, d)))
                }
            },
            init: function() {
                var e = this,
                    t = e.scrollbar,
                    a = e.$el;
                e.params.scrollbar = S(a, e.params.scrollbar, e.params.createElements, {
                    el: "swiper-scrollbar"
                });
                ...
                if (i.el) {
                    ...
                    0 === r.length && (r = v('<div class="' + e.params.scrollbar.dragClass + '"></div>'), s.append(r)), x(t, {
                        $el: s,
                        el: s[0],
                        $dragEl: r,
                        dragEl: r[0]
        ...
        j = {
            setTransform: function(e, t) {
                ...
                n || l ? (n = n || "0", l = l || "0") : this.isHorizontal() ? (n = r, l = "0") : (l = r, n = "0"), n = n.indexOf("%") >= 0 ? parseInt(n, 10) * t * s + "%" : n * t * s + "px", l = l.indexOf("%") >= 0 ? parseInt(l, 10) * t + "%" : l * t + "px", null != d && (i[0].style.opacity = d - (d - 1) * (1 - Math.abs(t))), null == o ? i.transform("translate3d(" + n + ", " + l + ", 0px)") : i.transform("translate3d(" + n + ", " + l + ", 0px) scale(" + (o - (o - 1) * (1 - Math.abs(t))) + ")")
            },
            setTranslate: function() {
                var e = this,
                    t = e.$el,
                ...
                t.children("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(t) {
                    ...
                    var r = t.progress;
                    e.params.slidesPerGroup > 1 && "auto" !== e.params.slidesPerView && (r += Math.ceil(a / 2) - i * (s.length - 1)), r = Math.min(Math.max(r, -1), 1), v(t).find("[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]").each(function(t) {
        ...
        U = {
            getDistanceBetweenTouches: function(e) {
                ...
                var t, a = e.targetTouches[0].pageX,
            ...
            onGestureEnd: function(e) {
                ...
                r.$imageEl && 0 !== r.$imageEl.length && (s.scale = Math.max(Math.min(s.scale, r.maxRatio), i.minRatio), r.$imageEl.transition(this.params.speed).transform("translate3d(0,0,0) scale(" + s.scale + ")"), s.currentScale = s.scale, s.isScaling = !1, 1 === s.scale && (r.$slideEl = void 0))
            },
            ...
            onTouchMove: function(e) {
                ...
                if (i.$imageEl && 0 !== i.$imageEl.length && (t.allowClick = !1, s.isTouched && i.$slideEl)) {
                    s.isMoved || (s.width = i.$imageEl[0].offsetWidth, s.height = i.$imageEl[0].offsetHeight, s.startX = y(i.$imageWrapEl[0], "x") || 0, s.startY = y(i.$imageWrapEl[0], "y") || 0, i.slideWidth = i.$slideEl[0].offsetWidth, i.slideHeight = i.$slideEl[0].offsetHeight, i.$imageWrapEl.transition(0));
                    var n = s.width * a.scale,
                        l = s.height * a.scale;
                    if (!(n < i.slideWidth && l < i.slideHeight)) {
                        if (s.minX = Math.min(i.slideWidth / 2 - n / 2, 0), s.maxX = -s.minX, s.minY = Math.min(i.slideHeight / 2 - l / 2, 0), s.maxY = -s.minY, s.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, s.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !s.isMoved && !a.isScaling && (t.isHorizontal() && (Math.floor(s.minX) === Math.floor(s.startX) && s.touchesCurrent.x < s.touchesStart.x || Math.floor(s.maxX) === Math.floor(s.startX) && s.touchesCurrent.x > s.touchesStart.x) || !t.isHorizontal() && (Math.floor(s.minY) === Math.floor(s.startY) && s.touchesCurrent.y < s.touchesStart.y || Math.floor(s.maxY) === Math.floor(s.startY) && s.touchesCurrent.y > s.touchesStart.y))) return void(s.isTouched = !1);
            ...
            in: function(e) {
                var t, a, i, s, r, l, o, d, p, u, c, h, f, m, g, $, b = n(),
                    w = this.zoom,
                    y = this.params.zoom,
                    _ = w.gesture,
                    E = w.image;
        ...
        Q = {
            ...
            setHistory: function(e, t) {
                ...
                if (this.history.initialized && this.params.history.enabled) {
                    ...
                    o && o.value === r || (this.params.history.replaceState ? a.history.replaceState({
                        value: r
        ...
        ei = {
            setTranslate: function() {
                var e, t = this.$el,
                    ...
                    c = 0;
                d.shadow && (p ? (0 === (e = a.find(".swiper-cube-shadow")).length && (e = v('<div class="swiper-cube-shadow"></div>'), a.append(e)), e.css({
                    height: s + "px"
                ...
                for (var h = 0; h < i.length; h += 1) {
                    ...
                    var b = Math.max(Math.min(f[0].progress, 1), -1),
                        ...
                        y = 0,
                        _ = 0;
                    m % 4 == 0 ? (w = -(4 * $) * l, _ = 0) : (m - 1) % 4 == 0 ? (w = 0, _ = -(4 * $) * l) : (m - 2) % 4 == 0 ? (w = l + 4 * $ * l, _ = l) : (m - 3) % 4 == 0 && (w = -l, _ = 3 * l + 4 * l * $), n && (w = -w), p || (y = w, w = 0);
                    ...
                    if (b <= 1 && b > -1 && (c = 90 * m + 90 * b, n && (c = -(90 * m) - 90 * b)), f.transform(E), d.slideShadows) {
                        ...
                        0 === x.length && (x = v('<div class="swiper-slide-shadow-' + (p ? "left" : "top") + '"></div>'), f.append(x)), 0 === C.length && (C = v('<div class="swiper-slide-shadow-' + (p ? "right" : "bottom") + '"></div>'), f.append(C)), x.length && (x[0].style.opacity = Math.max(-b, 0)), C.length && (C[0].style.opacity = Math.max(b, 0))
                    }
                }
                if (a.css({
            ...
            setTranslate: function() {
                for (var e = this.slides, t = this.rtlTranslate, a = 0; a < e.length; a += 1) {
                    ...
                    if (this.isHorizontal() ? t && (r = -r) : (o = l, l = 0, n = -r, r = 0), i[0].style.zIndex = -Math.abs(Math.round(s)) + e.length, this.params.flipEffect.slideShadows) {
                        ...
                        0 === d.length && (d = v('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "left" : "top") + '"></div>'), i.append(d)), 0 === p.length && (p = v('<div class="swiper-slide-shadow-' + (this.isHorizontal() ? "right" : "bottom") + '"></div>'), i.append(p)), d.length && (d[0].style.opacity = Math.max(-s, 0)), p.length && (p[0].style.opacity = Math.max(s, 0))
                    }
        ...
        er = {
            setTranslate: function() {
                for (var e = this.width, t = this.height, a = this.slides, i = this.slidesSizesGrid, s = this.params.coverflowEffect, r = this.isHorizontal(), n = this.translate, l = r ? e / 2 - n : t / 2 - n, o = r ? s.rotate : -s.rotate, d = s.depth, p = 0, u = a.length; p < u; p += 1) {
                    var c = a.eq(p),
                        h = i[p],
                    ...
                    .001 > Math.abs(y) && (y = 0), .001 > Math.abs(w) && (w = 0), .001 > Math.abs($) && ($ = 0), .001 > Math.abs(m) && (m = 0), .001 > Math.abs(g) && (g = 0), .001 > Math.abs(_) && (_ = 0);
                    ...
                    if (c.transform(E), c[0].style.zIndex = 1 - Math.abs(Math.round(f)), s.slideShadows) {
                        ...
                        0 === x.length && (x = v('<div class="swiper-slide-shadow-' + (r ? "left" : "top") + '"></div>'), c.append(x)), 0 === C.length && (C = v('<div class="swiper-slide-shadow-' + (r ? "right" : "bottom") + '"></div>'), c.append(C)), x.length && (x[0].style.opacity = f > 0 ? f : 0), C.length && (C[0].style.opacity = -f > 0 ? -f : 0)
                    }
                }
            },
            setTransition: function(e) {
        ...
        en = {
            init: function() {
                ...
                var a = e.constructor;
                return t.swiper instanceof a ? (e.thumbs.swiper = t.swiper, x(e.thumbs.swiper.originalParams, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                }), x(e.thumbs.swiper.params, {
                    watchSlidesProgress: !0,
                    slideToClickedSlide: !1
                })) : _(t.swiper) && (e.thumbs.swiper = new a(x({}, t.swiper, {
                ...
                if (t) {
                    ...
                    if (!(s && v(s).hasClass(e.params.thumbs.slideThumbActiveClass) || null == i)) {
                        if (a = t.params.loop ? parseInt(v(t.clickedSlide).attr("data-swiper-slide-index"), 10) : i, e.params.loop) {
                            ...
                            var n = e.slides.eq(r).prevAll('[data-swiper-slide-index="' + a + '"]').eq(0).index(),
            ...
            update: function(e) {
                ...
                if (t) {
                    ...
                    if (this.realIndex !== t.realIndex || s) {
                        ...
                        s && (r += "next" === n ? i : -1 * i), t.visibleSlidesIndexes && 0 > t.visibleSlidesIndexes.indexOf(r) && (t.params.centeredSlides ? r = r > l ? r - Math.floor(a / 2) + 1 : r + Math.floor(a / 2) - 1 : r > l && t.params.slidesPerGroup, t.slideTo(r, e ? 0 : void 0))
                    }
                    var p = 1,
            ...
            on: {
                ...
                click: function(e, t) {
                    ...
                    if (e.params.navigation.hideOnClick && !v(n).is(r) && !v(n).is(s)) {
                        ...
                        s ? a = s.hasClass(e.params.navigation.hiddenClass) : r && (a = r.hasClass(e.params.navigation.hiddenClass)), !0 === a ? e.emit("navigationShow") : e.emit("navigationHide"), s && s.toggleClass(e.params.navigation.hiddenClass), r && r.toggleClass(e.params.navigation.hiddenClass)
                    }
                }
            }
        }, {
...
! function(n, e) {
            ...
            return i.init = function() {
                ...
                i.addClass("metismenu"), i.find(t.parentTrigger + "." + d).children(t.triggerElement).attr("aria-expanded", "true"), i.find(t.parentTrigger + "." + d).parents(t.parentTrigger).addClass(d), i.find(t.parentTrigger + "." + d).parents(t.parentTrigger).children(t.triggerElement).attr("aria-expanded", "true"), i.find(t.parentTrigger + "." + d).has(t.subMenu).children(t.subMenu).addClass(c + " " + u), i.find(t.parentTrigger).not("." + d).has(t.subMenu).children(t.subMenu).addClass(c), i.find(t.parentTrigger).children(t.triggerElement).on(f.CLICK_DATA_API, function(i) {
                    ...
                    if ("true" !== r.attr("aria-disabled")) {
                        ...
                        a.hasClass(d) ? (r.attr("aria-expanded", "false"), e.removeActive(a)) : (r.attr("aria-expanded", "true"), e.setActive(a), t.toggle && (e.removeActive(s), o.attr("aria-expanded", "false"))), t.onTransitionStart && t.onTransitionStart(i)
                    }
                })
                ...
                if (!this.transitioning && !n(e).hasClass(p)) {
                    ...
                    if (i.trigger(r), !r.isDefaultPrevented()) {
                        ...
                        i.removeClass(c).addClass(p).height(0), this.setTransitioning(!0), i.height(e[0].scrollHeight).one(a.TRANSITION_END, function() {
                            t.config && t.element && (i.removeClass(p).addClass(c + " " + u).height(""), t.setTransitioning(!1), i.trigger(f.SHOWN))
    ...
    return n.fn[s] = m.jQueryInterface, n.fn[s].Constructor = m, n.fn[s].noConflict = function() {
