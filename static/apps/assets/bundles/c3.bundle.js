    ...
    return w.chart = {
        ...
        return function() {
            ...
            G.flowing = !0, G.data.targets.forEach(function(t) {
                t.values.splice(0, x)
            }), n = G.updateXDomain(r, !0, !0), G.updateXGrid && G.updateXGrid(!0), t = a.orgDataCount ? 1 === a.orgDataCount || (_ && _.x) === (v && v.x) ? G.x(y[0]) - G.x(n[0]) : G.isTimeSeries() ? G.x(y[0]) - G.x(n[0]) : G.x(_.x) - G.x(v.x) : 1 !== G.data.targets[0].values.length ? G.x(y[0]) - G.x(n[0]) : G.isTimeSeries() ? (_ = G.getValueOnIndex(G.data.targets[0].values, 0), v = G.getValueOnIndex(G.data.targets[0].values, G.data.targets[0].values.length - 1), G.x(_.x) - G.x(v.x)) : O(n) / 2, i = O(y) / O(n), e = "translate(" + t + ",0) scale(" + i + ",1)", G.hideXGridFocus(), R.transition().ease("linear").duration(m).each(function() {
        ...
        t.mouse && (n = t.mouse), t.data ? e = i.isMultipleX() ? (n = [i.x(t.data.x), i.getYScale(t.data.id)(t.data.value)], null) : P(t.data.index) ? t.data.index : i.getIndexByX(t.data.x) : void 0 !== t.x ? e = i.getIndexByX(t.x) : void 0 !== t.index && (e = t.index), i.dispatchEvent("mouseover", e, n), i.dispatchEvent("mousemove", e, n), i.config.tooltip_onshow.call(i, t.data)
        ...
        var e = this,
            ...
            o = 0,
            s = 0;
        return i - r != 0 || e.isCategorized() || (r = e.isTimeSeries() ? (i = new Date(.5 * i.getTime()), new Date(1.5 * r.getTime())) : (i = 0 === i ? 1 : .5 * i, 0 === r ? -1 : 1.5 * r)), (i || 0 === i) && (o = e.isTimeSeries() ? new Date(i.getTime() - a.left) : i - a.left), (r || 0 === r) && (s = e.isTimeSeries() ? new Date(r.getTime() + a.right) : r + a.right), [o, s]
        ...
        t = t || s.eventRect.data(function(t) {
            return t
        }), r = s.isMultipleX() ? (n = e = 0, i = s.width, s.height) : (o = !s.isCustomX() && !s.isTimeSeries() || s.isCategorized() ? (a = s.getEventRectWidth(), function(t) {
            return s.x(t.x) - a / 2
        ...
        }), e = u.axis_rotated ? 0 : o, n = u.axis_rotated ? o : 0, i = u.axis_rotated ? s.width : a, u.axis_rotated ? a : s.height), t.attr("class", s.classEvent.bind(s)).attr("x", e).attr("y", n).attr("width", i).attr("height", r)
        ...
        }), f = H(t = t || {}, "withTransition", !0), g = H(t, "withTransitionForTransform", !0), m.isLegendInset && (R = w.legend_inset_step ? w.legend_inset_step : p.length, m.updateLegendStep(R)), o = m.isLegendRight ? (i = function(t) {
            return A * k[t]
        }, function(t) {
            return G[k[t]] + M[t]
        ...
        var r, a = this.getScale(t, e, this.isTimeSeries()),
            o = n ? a.domain(n) : a;
        for (r in a = this.isCategorized() ? (i = i || function() {
                return 0
            }, function(t, e) {
                var n = o(t) + i(t);
        ...
        var s = this,
            ...
            i = function(t, e) {
                return 0 < u.data_groups.length ? n(t, e)[0][1] : l.call(s, t.id)(t.value)
            };
        return c = u.axis_rotated ? c.x(i).y(e) : c.x(e).y(i), u.line_connectNull || (c = c.defined(function(t) {
                return null != t.value
            })),
            function(t) {
                var e = u.line_connectNull ? s.filterRemoveNull(t.values) : t.values,
                    ...
                    r = 0,
                    a = 0;
                return (s.isLineType(t) ? u.data_regions[t.id] ? s.lineWithRegions(e, n, i, u.data_regions[t.id]) : (s.isStepType(t) && (e = s.convertValuesToStep(e)), c.interpolate(s.getInterpolate(t))(e)) : (e[0] && (r = n(e[0].x), a = i(e[0].value)), u.axis_rotated ? "M " + a + " " + r : "M " + r + " " + a)) || "M 0 0"
            }
        ...
        var r = this,
            ...
            u = function(t, e) {
                return 0 < a.data_groups.length ? n(t, e)[0][1] : i.call(r, t.id)(r.getAreaBaseValue(t.id))
            },
            c = function(t, e) {
                return 0 < a.data_groups.length ? n(t, e)[1][1] : i.call(r, t.id)(t.value)
            };
        return o = a.axis_rotated ? o.x0(u).x1(c).y(s) : o.x(s).y0(a.area_above ? 0 : u).y1(c), a.line_connectNull || (o = o.defined(function(t) {
                return null !== t.value
            })),
            function(t) {
                var e = a.line_connectNull ? r.filterRemoveNull(t.values) : t.values,
                    n = 0,
                    i = 0;
                return (r.isAreaType(t) ? (r.isStepType(t) && (e = r.convertValuesToStep(e)), o.interpolate(r.getInterpolate(t))(e)) : (e[0] && (n = r.x(e[0].x), i = r.getYScale(t.id)(e[0].value)), a.axis_rotated ? "M " + i + " " + n : "M " + n + " " + i)) || "M 0 0"
            }
        ...
        return i = a.config.axis_rotated ? (r = a.isBarType(e) ? 4 : 6, t[2][1] + r * (e.value < 0 ? -1 : 1)) : a.hasType("bar") ? (t[2][0] + t[0][0]) / 2 : t[0][0], null === e.value && (i > a.width ? i = a.width - o.width : i < 0 && (i = 4)), i
        ...
        var r, a, o, s, u, c = this,
            ...
            d = c.hasArcType(),
            f = h.mouse(i);
        return d ? (a = (c.width - (c.isLegendRight ? c.getLegendWidth() : 0)) / 2 + f[0], s = c.height / 2 + f[1] + 20) : (r = c.getSvgLeft(!0), s = l.axis_rotated ? (o = (a = r + f[0] + 100) + e, u = c.currentWidth - c.getCurrentPaddingRight(), c.x(t[0].x) + 20) : (o = (a = r + c.getCurrentPaddingLeft(!0) + c.x(t[0].x) + 20) + e, u = r + c.currentWidth - c.getCurrentPaddingRight(), f[1] + 15), u < o && (a -= o - u + 20), s + n > c.currentHeight && (s -= n + 30)), s < 0 && (s = 0), {
            top: s,
            left: a
        }
...
function() {
    ...
    function Ct() {
        for (var t, e = Xa, n = 1 / 0; e;) e = e.c ? (e.t < n && (n = e.t), (t = e).n) : t ? t.n = e.n : Xa = e.n;
        return Ha = t, n
    }
        ...
        function t(l, h, d, f, g) {
            return function() {
                var i, t = qr.event.target.correspondingElement || qr.event.target,
                    ...
                    u = U(t),
                    c = h(r, s);
                i = x ? [(i = x.apply(this, arguments)).x - c[0], i.y - c[1]] : [0, 0], a({
                    type: "dragstart"
                })
            }
        }
            ...
            numberFormat: (e = t, A = e.decimal, s = e.thousands, u = e.grouping, i = e.currency, T = u && s ? function(t, e) {
                ...
                return function(t) {
                    ...
                    if (o < 0) {
                        ...
                        a = s < 0 ? (r = t, "") : (r = t.substring(0, s), t.substring(s))
    ...
    bn.prototype.prepare = function() {
        ...
        insert: function(t, e) {
            ...
            if (t) {
                ...
                n = t
            } else n = this._ ? (t = Dn(this._), e.P = null, (e.N = t).P = t.L = e, t) : (e.P = e.N = null, this._ = e, null);
    ...
    var Zo = function() {
        ...
        Ko = qr.map({
            ...
            elastic: function(e, n) {
                var i;
                return arguments.length < 2 && (n = .45), i = arguments.length ? n / ba * Math.asin(1 / e) : (e = 1, n / 4),
                    function(t) {
    ...
    qr.layout.histogram = function() {
        ...
        function h(t) {
            ...
            if (e && e.length) {
                ...
                for (l(s, a.dx * a.dy / t.value), o.area = 0; 0 < (r = s.length);) o.push(n = s[r - 1]), o.area += n.area, u = "squarify" !== x || (i = d(o, c)) <= u ? (s.pop(), i) : (o.area -= o.pop().area, f(o, c, a, !1), c = Math.min(a.dx, a.dy), o.length = o.area = 0, 1 / 0);
